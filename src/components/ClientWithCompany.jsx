...
const ClientWithCompany = () => {
  ...
  const formSubmit = (e) => {
    ...
    axios.post(baseURL, user_data1).then((res) => {
      ...
      // verify email
      axios.post(verifyEmailURL, user_data2).then((verificationResponse) => {
        ...
        if (isChecked1 === true) {
          axios.get(personid + user_data2.email).then((personUIDD) => {
            ...
            const clientjob_data = {
              ...
              project_location_type:
                data.project_location_type || randomProjectLocationType,
              years_of_experience_preferred:
                data.years_of_experience_preferred ||
                randomYearsofExperiencePreferred,
              project_start_date:
                data.project_start_date || randomprojectStartDate,
              project_expire_date:
                data.project_expire_date || randomprojectExpireDate,
              project_deadline_date:
                data.project_deadline_date || randomprojectDeadlineDate,
    ...
    <div>
      ...
      <div className="col-sm-6 form-group label1">
        ...
        />
            ...
            {isChecked && (
              <div className="col-sm-6 form-group label1">
                <label htmlFor="companydetailsradiovalue">
                  Company Details
                </label>
                <input
                  type="text"
            ...
            {isChecked && (
              <div className="col-sm-6 form-group label1">
                <label htmlFor="registrationNumberCIN">
            ...
            {isChecked && (
              <div className="col-sm-6 form-group label1">
                <label htmlFor="addressRegisteredOffice">
            ...
            {isChecked1 && (
              <div className="col-sm-6 form-group label1">
                <label htmlFor="project_location_type">
            ...
            {isChecked1 && (
              <div className="col-sm-6 form-group label1">
                <label htmlFor="years_of_experience_preferred">
            ...
            {isChecked1 && (
              <div className="col-sm-6 form-group label1">
                <label htmlFor="project_deadline_date">
...
export default ClientWithCompany;
